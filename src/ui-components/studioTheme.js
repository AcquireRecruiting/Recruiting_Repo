...
export default createTheme({
  ...
  tokens: {
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsla(213, 31%, 61%, 0.86)" },
          20: { value: "hsl(209, 15%, 50%)" },
          40: { value: "hsla(222, 30%, 36%, 0.84)" },
          60: { value: "hsl(219, 23%, 30%)" },
          80: { value: "hsl(215, 23%, 12%)" },
          90: { value: "hsl(190, 18%, 4%)" },
          100: { value: "hsl(0, 0%, 0%)" },
        },
        secondary: {
      ...
      font: {
        ...
        secondary: { value: "hsla(0, 0%, 0%, 0.73)" },
      ...
      background: {
        primary: { value: "hsla(207, 32%, 40%, 0.61)" },
