      ...
      >
        ...
        >
          <Flex
            width="unset"
            height="unset"
            {...getOverrideProps(overrides, "Badge13137")}
          ></Flex>
          <Flex
            width="unset"
            height="unset"
            {...getOverrideProps(overrides, "Badge13138")}
          ></Flex>
          <Flex
            width="unset"
            height="unset"
            {...getOverrideProps(overrides, "Badge13139")}
          ></Flex>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Feature13146")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Icon13147")}
            >
              <Icon
                width="17.59px"
                height="13.41px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vector13148")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Feature13150")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Icon13151")}
            >
              <Icon
                width="17.59px"
                height="13.41px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Feature13154")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Icon13155")}
            >
              <Icon
                width="17.59px"
                height="13.41px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vector13156")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
