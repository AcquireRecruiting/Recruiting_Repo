...
export { default as AcquireRecruitingHome } from "./AcquireRecruitingHome";
export { default as Acquirelogogold1 } from "./Acquirelogogold1";
export { default as AcqureLogo } from "./AcqureLogo";
