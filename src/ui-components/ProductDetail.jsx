    ...
    >
      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 713272")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <View
            width="unset"
            height="1px"
            {...getOverrideProps(overrides, "Divider13275")}
          ></View>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 713276")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <View
            width="unset"
            height="1px"
            {...getOverrideProps(overrides, "Divider13279")}
          ></View>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 713280")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 2713285")}
        >
          <Flex
            width="unset"
            height="unset"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 2713288")}
        >
          <Text
            fontFamily="Inter"
            fontSize="14px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 2813291")}
          >
            <Flex
              width="85px"
              height="unset"
              {...getOverrideProps(overrides, "Button13292")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button13293")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button13294")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button13295")}
            ></Flex>
          </Flex>
          <Flex
            gap="24px"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 2813296")}
          >
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button13297")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button13298")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button13299")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button13300")}
            ></Flex>
          </Flex>
          <Flex
            width="unset"
            height="unset"
            {...getOverrideProps(overrides, "Button13301")}
          ></Flex>
        </Flex>
      </Flex>
    </Flex>
