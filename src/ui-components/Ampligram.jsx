  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            ...
            padding="0px 0px 0px 0px"
            objectFit="cover"
            {...getOverrideProps(overrides, "image13098")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icon13101")}
          >
            <Icon
              width="4px"
              height="16px"
              ...
              left="41.67%"
              right="41.67%"
              {...getOverrideProps(overrides, "Vector13102")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      <Image
        ...
        padding="0px 0px 0px 0px"
        objectFit="cover"
        {...getOverrideProps(overrides, "image13103")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIcon13106")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            {...getOverrideProps(overrides, "MyIcon13107")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            padding="0px 0px 0px 0px"
            type="send"
            {...getOverrideProps(overrides, "MyIcon13108")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icon13110")}
          >
            <Icon
              width="14px"
              height="18px"
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "Vector13111")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
