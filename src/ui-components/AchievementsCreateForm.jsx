...
import { createAchievements } from "../graphql/mutations";
const client = generateClient();
export default function AchievementsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setProfessionalachievements(initialValues.professionalachievements);
    setErrors({});
  };
  const validations = {
    professionalachievements: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createAchievements.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AchievementsCreateForm")}
      {...rest}
    >
      <TextField
