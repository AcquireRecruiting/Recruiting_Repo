  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              ...
              padding="0px 0px 0px 0px"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIcon13193")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Share13195")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Share13196")}
            ></Text>
            <MyIcon
              width="24px"
              height="24px"
              ...
              {...getOverrideProps(overrides, "MyIcon13197")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="share"
              {...getOverrideProps(overrides, "MyIcon13198")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIcon13199")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read more13201")}
      >
        <MyIcon
          width="24px"
          height="24px"
          ...
          padding="0px 0px 0px 0px"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIcon13202")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read more13203")}
        ></Text>
      </Flex>
    </Flex>
  );
