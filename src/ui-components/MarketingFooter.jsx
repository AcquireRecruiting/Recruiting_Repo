...
export default function MarketingFooter(props) {
  ...
  return (
    <Flex
      ...
      backgroundColor="rgba(162, 185, 203, 0.54)"
    ...
    >
      ...
      <View
        width="unset"
        height="1px"
        {...getOverrideProps(overrides, "Divider13340")}
      ></View>
      <Flex
        gap="24px"
        direction="row"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 40513341")}
      >
        <Flex
          gap="8px"
          direction="column"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 40513354")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
      ...
      <View
        width="unset"
        height="1px"
        {...getOverrideProps(overrides, "Divider13359")}
      ></View>
      <Flex
        gap="0"
        direction="row"
      ...
      >
        <View
          width="127.88px"
          height="18.91px"
          {...getOverrideProps(overrides, "LogoWithText/neutral")}
        ></View>
        <Text
          fontFamily="Inter"
          fontSize="16px"
